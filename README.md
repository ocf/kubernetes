...
Install devenv and run `devenv shell` in the root of the repo after cloning it. You won't need to run this command if you have direnv installed; the tools defined in `devenv.nix` will become immediately available upon entering the repository.
